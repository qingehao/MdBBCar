...
#define UART3_DMA_RX_IRQHandler          DMA1_Stream0_IRQHandler
#define UART3_RX_DMA_RCC                 RCC_AHB1ENR_DMA1EN
#define UART3_RX_DMA_INSTANCE            DMA1_Stream0
#define UART3_RX_DMA_REQUEST             DMA_REQUEST_USART3_RX
#define UART3_RX_DMA_IRQ                 DMA1_Stream0_IRQn
#endif

/* DMA1 stream1 */
#if defined(BSP_UART3_TX_USING_DMA) && !defined(UART3_TX_DMA_INSTANCE)
#define UART3_DMA_TX_IRQHandler          DMA1_Stream1_IRQHandler
#define UART3_TX_DMA_RCC                 RCC_AHB1ENR_DMA1EN
#define UART3_TX_DMA_INSTANCE            DMA1_Stream1
#define UART3_TX_DMA_REQUEST             DMA_REQUEST_USART3_TX
#define UART3_TX_DMA_IRQ                 DMA1_Stream1_IRQn
#endif
